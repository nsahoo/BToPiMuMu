...
// Tue Dec  8 07:49:01 2015 by ROOT version 5.32/00
// from TTree tree/BToPiMuMu
// found on file: BToPiMuMu.root
//////////////////////////////////////////////////////////

#ifndef SingleBToPiMuMuSelector_h
#define SingleBToPiMuMuSelector_h
...
class SingleBToPiMuMuSelector : public TSelector {
public :
   ...
   SingleBToPiMuMuSelector(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~SingleBToPiMuMuSelector() { }
   ...
   //ClassDef(SingleBToPiMuMuSelector,0);
   int SelectB(string); 
...
#ifdef SingleBToPiMuMuSelector_cxx
void SingleBToPiMuMuSelector::Init(TTree *tree)
{
...
Bool_t SingleBToPiMuMuSelector::Notify()
{
...
#endif // #ifdef SingleBToPiMuMuSelector_cxx
